...
namespace Task_2
{
    ...
    class Program
    {
        ...
        {
            TriangleComp tc = new(new (0, 0), new (0, 1), new (1, 0));
            Console.WriteLine(tc.Area + " " + tc.PointInTriangle(new (0.1, 0.1)));
            int n = 5;
            TriangleComp[] triangleComps = new TriangleComp[n];
            triangleComps[0] = new(new (0, 0), new (0, 1), new (1, 0));
            triangleComps[1] = new(new (1, 0), new (6, 1), new (1, 9));
            triangleComps[2] = new(new (1, 2), new (0, 1), new (5, 9));
            triangleComps[3] = new(new (-1, 3), new (0, 1), new (1, 10));
            triangleComps[4] = new(new (7, 6), new (7, 1), new (1, 0));
